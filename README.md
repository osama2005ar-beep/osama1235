...
<head>
    ...
    <title>موقع برقيات الشؤون الأدارية</title>
    <style>
        body {
            margin: 0;
            padding: 0;
    ...
    <div class="container">
        ...
        <div id="formResignation" class="form-section">
            ...
            <select id="soldierRank" required>
                ...
                <option value="<@&1271924904530542738>">نقيب</option>
...
[<@1321526146390556796>]**`;
        ...
        function copyReassignmentAdmin() {
            try {
